				...
				var createDiv = function(){
					...
					gVerify.gVerify();
				        ...
				        $(".v-img-code").blur(function(){
				            var res = verifyCode.validate($(".v-img-code").val());
				            if(res){
